...
const ColumnConfigModal = ({open, close, position, headers, setTableHeaders, setSortDirection}: ColumnConfigModalProps) => {
  ...
  const handleClick = (e: React.ChangeEvent<HTMLInputElement>, header: ITableHeader) => {
    const copy = [...headers];
